...
namespace WebTiki.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            List<DanhMuc> cList = db.DanhMuc.ToList();
            //return PartialView("Tên partial", đối tượng);
            return PartialView("Menu", cList);
        }

        // GET: Category/categoryID
        public ActionResult DanhMuc(long DanhMucID)
        {
            List<SANPHAM> cList = db.SANPHAM.Where(x => x.DanhMucID == DanhMucID).ToList();
